...
- **Application** — `AppBuilder`, awaitable conditions, and distributed tracing helpers for clean service startup
- **Collections** — `CircularQueue`, `HandlerRegistry`, and other collection utilities
- **Extensions** — Conditional invocation helpers and other type-based extensions
